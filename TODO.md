...
- * [X] Outils de positionnement du anchropoint dans la visualisation3D
- * [X] Ajuster les Camera viewers
  - * [X] dropdown dans le web camera
  - * [X] agrégation dans un widget permettant de switch entre rtsp et webcam
  - * [X] Ajustement responsive à 100% hauteur du widget( pas de la widow) pour la vidéo (on resize se réajuste)
- * [X] Ajout de l'indicateur E-Stop
- * [X] Ajouts des controls
